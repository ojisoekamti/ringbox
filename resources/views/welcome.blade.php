  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <div class="logo mr-auto">
        <h1 class="text-light"><a href="index.html"><img src="{{ asset('assets/img/ringbox-logo.gif') }}" alt=""></a></h1>
      ...
      <div class="row">
        <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
          <div data-aos="zoom-out">
            <h1>CRM for the sales team <span>RingBox</span></h1>
            <h2>The best CRM system for sales teams with all essential tools. Sales channels, channel management, sales reports, 360-degree customer display, support for repeat sales and sales automation
            </h2>
