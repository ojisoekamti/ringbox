...
<nav class="navbar navbar-light bg-white container-fluid col-md-8">
    <ul class="nav nav-pills" id="pills-tab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link " id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab"
                aria-controls="pills-profile" aria-selected="false">List Product</a>
        </li>
    </ul>
</nav>

<div class="container-fluid bg-white p-3 col-md-8">
                    ...
                    <form action="{{ route('admin.actlists.store') }}" method="post" class="leadsForm">
                        ...
                        <div class="form-row d-flex justify-content-center ">
                            <div class="form-group col-md-6">
                                <label for="leadsId">Quotation Id</label>
                                <input type="text" class="form-control" id="leadsId" name="leadsId" value="{{$leadsId ?? ''}}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="leadsId">Opportunity Id</label>
                                <input type="text" class="form-control" id="leadsId" name="leadsId" value="{{$leadsId ?? ''}}" disabled>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="idSales" name="idSales" value="ADMIN-{{$user->id ?? ''}}" disabled>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="salesName">Sales Name</label>
                                <input type="text" class="form-control" id="salesName" name="salesName" value="{{$user->name ?? ''}}" disabled>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <a href="{{ route('master.accounts.create',['form'=>'modal','id'=>$id??'']) }}" class="input-group-texts btn btn-primary createAccount" data-toggle="modal" data-target="#MyModal" id="MyModalBtn"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3 ">
                                ...
                                <input type="text" class="form-control" id="phoneCall" name="phoneCall" disabled>
                            </div>
                            <div class="form-group col-md-3">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="datepicker form-control" id="date" placeholder=" yyyy-mm-dd" name="date" autocomplete="off">
                                </div>
                            </div>
                    ...
                    <div class="table">
                        <div class="row">
                            <div class="col-sm-10 pb-2">
                                <a href="#" class="btn btn-outline-primary addActivity" data-toggle="modal" data-target="#MyModal" id="MyModalBtn"><i class="fa fa-plus"></i> Add Activity</a>
                            </div>
