                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <select class="form-control accountId " name="accountId">
                                        @if ($data['accountData'])
                                        <option value="{{$data['accountData'][0]->id}}">
                                            {{$data['accountData'][0]->name}}
                                        </option>
                                        @endif
                                    </select>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <select class="form-control contactPersonId " name="contactPersonId">
                                        @if ($data['contactData'])
                                        <option value="{{$data['contactData'][0]->id}}">
                                    ...
                                    <div class="input-group-append">
                                        <a @if($data['accountData'])
                                            href="{{ route('master.contactPersons.create',['form'=>'leads','id'=>($id)??'','accountId'=>$data['accountData'][0]->id]) }}"
                                            @else href="#" @endif
                                            class="input-group-texts btn btn-primary createContact" data-toggle="modal"
                                            data-target="#MyModal" id="MyModalBtn" id="contactPerson"><i
