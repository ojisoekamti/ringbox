...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-sm-10">
                    <a href="{{route('master.accounts.create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> Add Data</a>
                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
          ...
          function fetch_data(page,query){
            $.ajax({
              url:"{{url('')}}/master/accounts/data?page="+page+"&query="+query,
